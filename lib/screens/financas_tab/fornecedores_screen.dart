            ...
            children: [
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    LinhaTabela(tabela: [
                      LinhaTabela.buildLinhaTabelaTile('provider.name'),
                      LinhaTabela.buildLinhaTabelaTile('provider.type'),
                    ...
                    LinhaTabela(
                      tabela: [
                        ...
                        LinhaTabela.buildLinhaTabelaTile('Pessoa Física'),
