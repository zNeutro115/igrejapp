...
class ReunioesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseContainer(
      headlerText: 'Sidebar.conferences',
      widget: [
        Container(
            ...
            children: [
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    LinhaTabela(tabela: [
                      LinhaTabela.buildLinhaTabelaTile('conference.date'),
                      LinhaTabela.buildLinhaTabelaTile('conference.network'),
                      LinhaTabela.buildLinhaTabelaTile('conference.cell'),
