...
class LideresScreen extends StatelessWidget {
  const LideresScreen({Key? key}) : super(key: key);
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    LinhaTabela(tabela: [
                      LinhaTabela.buildLinhaTabelaTile('leader.name_leader'),
                      LinhaTabela.buildLinhaTabelaTile('leader.name_cell'),
