...
class CoordenadoresScreen extends StatelessWidget {
  const CoordenadoresScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BaseContainer(
      headlerText: 'Cordenadores',
      widget: [
        Container(
                  ...
                  children: [
                    ...
                    LinhaTabela(tabela: [
                      LinhaTabela.buildLinhaTabelaTile(
                          'coordinator.name_coordinato'),
                      LinhaTabela.buildLinhaTabelaTile(
                          'coordinator.name_network'),
