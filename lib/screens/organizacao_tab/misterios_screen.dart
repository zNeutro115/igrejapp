...
class MinisteriosScreen extends StatelessWidget {
  const MinisteriosScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BaseContainer(
      headlerText: 'Ministerios',
      widget: [
        Container(
            ...
            children: [
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    LinhaTabela(tabela: [
                      LinhaTabela.buildLinhaTabelaTile('ministre.name'),
                      LinhaTabela.buildLinhaTabelaTile('ministre.leader'),
                      LinhaTabela.buildLinhaTabelaTile('Ações'),
                    ]),
                    const Divider(height: 8, endIndent: 16, indent: 16),
                    LinhaTabela(
                      tabela: [
                        LinhaTabela.buildLinhaTabelaTile('11111111'),
                    ...
                    LinhaTabela(
                      tabela: [
                        LinhaTabela.buildLinhaTabelaTile('aaa'),
                        LinhaTabela.buildLinhaTabelaTile('Pessoa do Banco'),
                        const EditDeleteWidget()
                      ],
                    ),
                    ...
                    LinhaTabela(
                      tabela: [
                        LinhaTabela.buildLinhaTabelaTile(
                            'Laboratorio Silveira Lab. Silveira'),
                        LinhaTabela.buildLinhaTabelaTile('Pessoa do Banco'),
                        const EditDeleteWidget()
                      ],
                    ),
