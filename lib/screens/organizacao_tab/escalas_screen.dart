...
class EscalasOrganizacoesScreen extends StatelessWidget {
  const EscalasOrganizacoesScreen({Key? key}) : super(key: key);
                  ...
                  children: [
                    LinhaTabela(
                      tabela: [
                        ...
                        LinhaTabela.buildLinhaTabelaTile('Evento'),
                        LinhaTabela.buildLinhaTabelaTile('Ministério'),
                        LinhaTabela.buildLinhaTabelaTile('Departamento'),
                    ...
                    LinhaTabela(
                      tabela: [
                        LinhaTabela.buildLinhaTabelaTile('26/07/2021'),
                        LinhaTabela.buildLinhaTabelaTile('07:04'),
                        LinhaTabela.buildLinhaTabelaTile('Teste'),
                        LinhaTabela.buildLinhaTabelaTile('2222222'),
                        LinhaTabela.buildLinhaTabelaTile('Edit'),
