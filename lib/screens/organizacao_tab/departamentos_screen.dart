              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    LinhaTabela(
                      tabela: [
                        LinhaTabela.buildLinhaTabelaTile('departament.name'),
                        LinhaTabela.buildLinhaTabelaTile('departament.leader'),
                    ...
                    LinhaTabela(
                      tabela: [
                        LinhaTabela.buildLinhaTabelaTile('vai'),
                        LinhaTabela.buildLinhaTabelaTile('Pessoa do Banco'),
                        const EditDeleteWidget()
                      ],
                    ),
