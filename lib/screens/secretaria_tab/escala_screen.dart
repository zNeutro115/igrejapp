...
class EscalaSecretariaScreen extends StatelessWidget {
  const EscalaSecretariaScreen({Key? key}) : super(key: key);
                ...
                child: Column(
                  children: [
                    LinhaTabela(tabela: [
                      ...
                      LinhaTabela.buildLinhaTabelaTile('Ministêrio'),
                    ...
                    LinhaTabela(
                      tabela: [
                        ...
                        LinhaTabela.buildLinhaTabelaTile('22222'),
