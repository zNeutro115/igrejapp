              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    LinhaTabela(
                      tabela: [
                        LinhaTabela.buildLinhaTabelaTile('reverv.period_start'),
                        LinhaTabela.buildLinhaTabelaTile('reverv.period_end'),
                        LinhaTabela.buildLinhaTabelaTile(
                            'reverv.period_people'),
