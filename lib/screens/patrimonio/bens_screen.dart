...
class BensScreen extends StatelessWidget {
  const BensScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BaseContainer(
      headlerText: 'Sigerbar.goods',
      widget: [
        Container(
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    LinhaTabela(
                      tabela: [
                        LinhaTabela.buildLinhaTabelaTile('good.name'),
                        LinhaTabela.buildLinhaTabelaTile('good.categorie'),
                        LinhaTabela.buildLinhaTabelaTile('good.code'),
                    ...
                    LinhaTabela(
                      tabela: [
                        LinhaTabela.buildLinhaTabelaTile('Situação'),
